...
export default function AssignmentForm({ onClose, mode, data }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <form className="bg-white flex flex-col rounded-[50px] px-[50px] py-[30px] w-1/3 min-w-[450px] gap-y-[35px]">
        ...
        <div className="space-y-3">
          <div className="flex flex-col gap-y-2">
            <label className="text-2xl text-mainBlue font-bold">Mã phân công</label>
            <input type="text" 
